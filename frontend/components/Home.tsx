    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: "url('/casal-hero.jpeg')",
            backgroundColor: '#333',
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center space-y-12">
            ...
            <p className="text-lg text-stone-600 leading-relaxed font-light max-max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 pt-12">
                ...
                <div className="p-8 border border-wedding-accent/20 rounded-sm hover:border-wedding-accent transition-colors duration-500">
                    ...
                    <div className="text-xs tracking-widest uppercase text-stone-400">{WEDDING_DETAILS.receptionLocation}</div>
                </div>
            </div>
        </div>
      </section>
