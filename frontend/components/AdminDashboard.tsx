...
import { Plus, Trash2, Edit2, Link as LinkIcon, Users, Check, X, Gift, ChevronDown, ChevronUp, Image as ImageIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-stone-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <header className="mb-10 text-center md:text-left">
            <h1 className="text-4xl font-serif text-wedding-primary mb-2">Painel de Controle</h1>
            <p className="text-stone-500 font-light">Gerencie os detalhes do seu grande dia.</p>
        </header>
